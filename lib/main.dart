...
import 'package:stacja/weather.dart';
...
class _BillSplitterState extends State<BillSplitter> {
  ...
  final _textStyle = TextStyle(color: Colors.grey.shade500, fontWeight: FontWeight.bold, fontSize: 20);
  final _buttonStyle = TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 20);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Kalkulator rachunku")),
      body: Container(
          ...
          children: [
            Container(
              ...
              child: Column(
                children: [
                  TextField(
                    controller: TextEditingController(text: _billValue.toString()),
                    style: _textStyle,
                  ...
                  Row(
                    ...
                    children: [
                      Text("Ilość osob:", style: _textStyle),
                      Row(
                        children: [
                          InkWell(
